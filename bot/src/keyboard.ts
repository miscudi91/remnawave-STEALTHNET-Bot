...
const DEFAULT_BUTTONS: BotButtonConfig[] = [
  { id: "tariffs", visible: true, label: "?? ������", order: 0, style: "success" },
  { id: "proxy", visible: true, label: "?? ������", order: 0.5, style: "primary" },
  { id: "my_proxy", visible: true, label: "?? ��� ������", order: 0.6, style: "primary" },
  { id: "singbox", visible: true, label: "?? �������", order: 0.55, style: "primary" },
  { id: "my_singbox", visible: true, label: "?? ��� �������", order: 0.65, style: "primary" },
  { id: "profile", visible: true, label: "?? �������", order: 1, style: "" },
  { id: "devices", visible: true, label: "?? ����������", order: 1.5, style: "primary" },
  { id: "topup", visible: true, label: "?? ��������� ������", order: 2, style: "success" },
  { id: "referral", visible: true, label: "?? ����������� ���������", order: 3, style: "primary" },
  { id: "trial", visible: true, label: "?? ���������� ����", order: 4, style: "success" },
  { id: "vpn", visible: true, label: "?? ����������� ������ VPN", order: 5, style: "danger", onePerRow: true },
  { id: "cabinet", visible: true, label: "?? Web �������", order: 6, style: "primary" },
  { id: "tickets", visible: true, label: "?? ������", order: 6.5, style: "primary" },
  { id: "support", visible: true, label: "?? ���������", order: 7, style: "primary" },
  { id: "promocode", visible: true, label: "??? ��������", order: 8, style: "primary" },
  { id: "gift", visible: true, label: "?? �������", order: 8.5, style: "primary" },
  { id: "extra_options", visible: true, label: "? ���. �����", order: 9, style: "primary" },
];
...
export function mainMenu(opts: {
  ...
  if (fromConfig && !list.some((b) => b.id === "devices")) {
    list.push({ id: "devices", visible: true, label: "?? ����������", order: 1.5, style: "primary" });
  }
  if (fromConfig && opts.showGift === true && !list.some((b) => b.id === "gift")) {
    list.push({ id: "gift", visible: true, label: "?? �������", order: 8.5, style: "primary" });
  }
  list = list
    .filter((b) => b.visible)
    .filter((b) => {
